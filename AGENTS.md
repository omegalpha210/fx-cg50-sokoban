...
- The project owner authorizes the validated source-only beta.2 icon update to the existing public repository. Preserve public ancestry and keep development history local; never force-push or move a published tag.
...
- Publish only an audited clean snapshot. Exclude private PDFs, absolute local configurations, caches/toolchains/secrets, and license-unclear maps, embedded binaries, or map screenshots except the explicit README exception below. Public own-code license is MIT; third-party rights remain separate.
...
- The owner's 2026-09-26 README request authorizes a narrow exception for actual level 1/16/31/59 screenshots and level 1 play/restart/completion views in docs/screenshots. Label host-rendered captures and retain separate upstream-map rights. This does not authorize publishing raw/generated maps, binaries, other map captures, or private development history.
